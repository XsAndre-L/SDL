...
export const build = (cwd: string = process.cwd()): BuildType => {
  ...
  return {
    ...
    linux_x86_64: {
      ...
      -DCMAKE_C_COMPILER=${CLANG} \
      -DCMAKE_CXX_COMPILER=${CLANGXX} \
      -DX11_X11_INCLUDE_PATH=${linux_x86_64}/include \
      -DX11_X11_LIB=${linux_x86_64}/lib/x86_64-linux-gnu/libX11.so \
    ...
    linux_aarch64: {
      ...
      -DCMAKE_C_COMPILER=${CLANG} \
      -DCMAKE_CXX_COMPILER=${CLANGXX} \
      -DX11_X11_INCLUDE_PATH=${linux_aarch64}/include \
      -DX11_X11_LIB=${linux_aarch64}/lib/aarch64-linux-gnu/libX11.so \
